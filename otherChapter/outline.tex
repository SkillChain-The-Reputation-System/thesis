...
\refstepcounter{subsubsection}
\subsubsection*{\thesubsubsection\quad Tập dữ liệu}
\begin{itemize}
...
\refstepcounter{subsubsection}
\subsubsection*{\thesubsubsection\quad Giới hạn và ràng buộc của đề tài}
\begin{itemize}
...
\refstepcounter{subsection}
\subsection*{\thesubsection\quad Cách tiếp cận dự kiến}
...
\refstepcounter{subsubsection}
\subsubsection*{\thesubsubsection\quad Sự khác biệt so với các nghiên cứu trước}
...
\refstepcounter{subsection}
\subsection*{\thesubsection\quad Kết quả dự kiến của đề tài}
...
\refstepcounter{subsection}
\subsection*{\thesubsection\quad Kế hoạch thực hiện}
...
\begin{center}
  \begin{tabular}{ p{7cm} p{7cm} }
    \textbf{
     ...
     & \textbf{
      \begin{tabular}[c]{@{}c@{}}
        \textit{\small Tp. Hồ Chí Minh, ngày\dots{} tháng\dots{} năm\dots} \\
