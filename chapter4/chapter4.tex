...
\begin{figure}[H]
  ...
  % \end{tikzpicture}
  \includegraphics[width=0.95\textwidth]{overall-architecture.png}
...
Để frontend tương tác với blockchain, hệ thống sử dụng thư viện \textbf{Wagmi} \cite{wagmi-web} kết hợp với \textbf{ConnectKit} \cite{connectkit-web} giúp tích hợp ví tiền điện tử như MetaMask hoặc CoinBase.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\textwidth]{data-model/overview.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\textwidth]{data-model/user-challenge-relationship.png}
...
\subsection{Mối quan hệ giữa người dùng và giải pháp}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{data-model/user-solution-relationship.png}
...
\subsection{Mối quan hệ của nhà tuyển dụng ở hành vi tìm kiếm ứng viên}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{data-model/user-recruitment-relationship.png}
...
\subsection{Mối quan hệ của nhà tuyển dụng ở hành vi tuyển thành công ứng viên}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{data-model/recruiter-relationship.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.87\textwidth]{system-workflow/contribute-challenge-flow.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.91\textwidth]{system-workflow/moderate-challenge-flow.png}
