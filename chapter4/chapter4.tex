...
\begin{itemize}
  \item Điểm chất lượng của thử thách được tổng hợp dựa trên tổng các yếu tố chất lượng của từng bài đánh giá của những người kiểm duyệt tham gia vào phiên đánh giá:
    \[Q_{\text{challenge}}=\frac{100}{F}\frac{\sum_{m=1}^{M} w_m \Bigl(\sum_{f=1}^{F} q_{mf}\Bigr)}{\sum_{m=1}^{M}w_m} \in[0,100]\]
