...
Trước tiên, cần chuẩn hóa các giá trị tin cậy cục bộ $sat_{ij}$ để đảm bảo tính công bằng. Nếu không chuẩn hóa, một peer độc hại có thể đánh giá tích cực cho các peer độc hại khác và
