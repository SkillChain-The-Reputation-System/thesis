...
\textbf{Uy tín toàn cục} được tính bằng tổng điểm trung bình uy tín chuyên môn trong tất cả các lĩnh vực thử thách mà hệ thống hỗ trợ:
\[R_{\text{global}} = \frac{1}{n}\sum_{i=1}^{n} R_{\text{domain}_i}\]
